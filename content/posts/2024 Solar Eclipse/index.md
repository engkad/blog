...
![Picture of me next to my camera setup](sitting-by-camera.jpeg)

Tripod set up with preview of partial eclipse (with solar filter). Note the sunspots!
![Tripod set up with preview of partial eclipse (with solar filter)](tripod-with-filter.jpeg)

![Close-up of partial eclipse preview](preview-filter-closeup.jpeg)

Image of crescent with solar filter
![Image of crescent with solar filter](crescent-filter.jpg)

Total eclipse with no filter
![Total eclipse with no filter](total-nofilter.jpg)

Phone picture of total eclipse
![Phone picture of total eclipse](phone-eclipse.jpeg)

Lauren and I taking a selfie with the total eclipse
![Lauren and I taking a selfie with the total eclipse](selfie.jpeg)
